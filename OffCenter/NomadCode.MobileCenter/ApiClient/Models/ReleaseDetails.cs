...
namespace NomadCode.MobileCenter.Models
{
    ...
    public partial class ReleaseDetails
    {
        ...
        /// Initializes a new instance of the ReleaseDetails class.
        /// </summary>
        public ReleaseDetails(string id = default(string), string status = default(string), string appName = default(string), string version = default(string), string shortVersion = default(string), string releaseNotes = default(string), string provisioningProfileName = default(string), double? size = default(double?), string minOs = default(string), string fingerprint = default(string), string uploadedAt = default(string), string downloadUrl = default(string), string appIconUrl = default(string), string installUrl = default(string), IList<DistributionGroup> distributionGroups = default(IList<DistributionGroup>))
        {
            Id = id;
            Status = status;
            AppName = appName;
        ...
        /// concept is now replaced with distributed. Any 'available' release
        ...
        /// distributed.&lt;br&gt;
        /// &lt;b&gt;unavailable&lt;/b&gt;: The uploaded release is not
        ...
        /// <summary>
        /// The href required to install a release on a mobile device. On iOS
