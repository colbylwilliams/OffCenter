...
namespace NomadCode.UIExtensions
{
	public static class ViewExtensions
	{
		...
		public static void ConstrainToFitParent (this UIView view, UIView parent)
		{
			view.TranslatesAutoresizingMaskIntoConstraints = false;
			parent.AddConstraints (NSLayoutConstraint.FromVisualFormat (@"H:|[view]|", 0, "view", view));
			parent.AddConstraints (NSLayoutConstraint.FromVisualFormat (@"V:|[view]|", 0, "view", view));
		}
	}
}